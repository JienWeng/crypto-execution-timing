...
The contribution is now specific enough to test: quantify which forecast information is useful at a given order size, and show which cost channel explains it. The pilot has not established the desired practical advantage or a stable order-size boundary. It should not be presented as a stronger completed paper merely because the design is more elaborate.
