...
\begin{figure}[h]
\centering\includegraphics[width=\linewidth]{study_design.png}
...
\begin{figure}[h]
\centering\includegraphics[width=\linewidth]{pilot_information_value.png}
...
\begin{figure}[h]
\centering\includegraphics[width=.78\linewidth]{oracle_value.png}
...
We also validated an open December 2025 Hyperliquid SOL order-event archive before using it. Accepted-order lifecycle records alone do not reconstruct visible depth: a direct reconstruction produces crossed books even after excluding conditional and non-resting orders. The dataset's separate 49.6 GB visible-book-diff stream lacks timestamps and requires a verified event join. No Hyperliquid policy outcome was computed. This failed data gate prevents a convenient but invalid expansion of the sample.
